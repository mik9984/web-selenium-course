...
public class TC001_Admin_SearchEmployee {
  ...
  @Test
  public void TC001_Admin_SearchEmployee_Scripts() {
	  ...
	  //hard assertion si no es igual a lo que tiene la prueba finaliza no continua la ejecucion
	  Assert.assertEquals(username, "Admin");
	  
	  //soft assertion si el valor no es igual la prueba sigue ejecutandose y al final de la prueba se tiene 
	  ...
	  //llamado del softassert para el reporte de fallas
